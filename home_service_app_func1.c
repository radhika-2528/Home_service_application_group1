...
#include<stdlib.h>
#include<string.h>
#include "home_service_app_header.h"
...
{										//view technician details function starts here
	...
	printf("\nTechnician__Name    Address            PhoneNumber      service_type        Years_of_service           Cost_of_service        Password\n");
	for(ptr1=start1;(ptr1);ptr1=ptr1->next1)
	{
		printf("\n%3s %15s %15ld  %15s  %15d  %15lf  %15s\n",ptr1->Tech_Name,ptr1->Address,ptr1->contact_number,ptr1->service_type,ptr1->Years_of_service,ptr1->cost_of_service,ptr1->password);
	}
	return EXIT_SUCCESS;
