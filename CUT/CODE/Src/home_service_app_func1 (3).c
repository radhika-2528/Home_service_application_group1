 ...
 *
 * 	*DESCRIPTION : This function is used to edit customer details in the customer database by the customer
 *
 * 	*RETURNS : No returns
 *
 *********************************************************************************************************/
 ...
 *
 * 	*DESCRIPTION : This function is used to view the customer details in the customer database
 *
 * 	*RETURNS  :  No returns
 *
 ***********************************************************************************************************/
...
/**************************************************************************************************************************
 *
 * 	*FUNCTION NAME : admin_del_cust_details
 *
 * 	*DESCRIPTION : This function is used to delete customer details in the customer database by the admin
 *
 * 	*RETURNS : No returns
 *
 ************************************************************************************************************************/
 ...
 *
 * 	*DESCRIPTION : This function is used to add the Technician details into the technician database by the technician
 *
 * 	*RETURNS : No returns
 *
 ***********************************************************************************************************************************/
...
}										//adding technician details function ends here

/*************************************************************************************************************************************
 *
 * 	*FUNCTION NAME : edit_tech_details
 *
...
/***********************************************************************************************************************************
 *
 * 	*FUNCTION NAME : admin_del_tech_details
 *
 * 	*DESCRIPTION : This function is used to delete technician details from the technician database 
 *
 * 	*RETURNS : No returns
 *
 *********************************************************************************************************************************/
...
/***********************************************************************************************************************************
 *
 *	*FUNCTION NAME : technician_report
 *
 *	*DESCRIPTION : This function is used to view the reports of technician and is handled by the admin
 *
 *	*RETURNS : No returns
 *
 **********************************************************************************************************************************/
...
{			                     //Generating technician reports here
	int technician_id;
	if(!start2)
	{
		printf("Empty List");
...
}											//Generating technician reports ends here

/***********************************************************************************************************************************
 *
 * 	*FUNCTION : completed_services
 *
 * 	*DESCRIPTION : This function is used to view the completed records in the service database
 *
 * 	*RETURNS : No returns
 *
 **********************************************************************************************************************************/
int completed_services()
{					//completed service database starts here
	if(!start2)
	{
		printf("\nList is empty\n");
		return EXIT_FAILURE;
	...
	return EXIT_SUCCESS;
}											//completed service database ends here

/***********************************************************************************************************************************
 *
 * 	*FUNCTION NAME : admin_add_cust_details
 *
 * 	*DESCRIPTION : This function is used to add  records in the customer database by the admin
 * 	
 * 	*RETURNS : No returns
 *
 *********************************************************************************************************************************/			
...
/***********************************************************************************************************************************
 *
 * 	*FUNCTION NAME : admin_edit_cust_details
 *
 * 	*DESCRIPTION : This function is used to edit records in the customer database by the admin
 * 	
 * 	*RETURNS : No returns
 *
 *********************************************************************************************************************************/			
...
/***********************************************************************************************************************************
 *
 * 	*FUNCTION NAME : admin_view_cust_details
 *
 * 	*DESCRIPTION : This function is used to view records in the customer database by the admin
 * 	
 * 	*RETURNS : No returns
 *
 *********************************************************************************************************************************/			
...
/***********************************************************************************************************************************
 *
 * 	*FUNCTION NAME : admin_add_tech_details
 *
 * 	*DESCRIPTION : This function is used to add  records into the technician database by the admin
 * 	
 * 	*RETURNS : No returns
 *
 *********************************************************************************************************************************/			
...
/***********************************************************************************************************************************
 *
 * 	*FUNCTION NAME : admin_edit_tech_details
 *
 * 	*DESCRIPTION : This function is used to edit records in the technician database by the admin
 * 	
 * 	*RETURNS : No returns
 *
 *********************************************************************************************************************************/			
...
/***********************************************************************************************************************************
 *
 * 	*FUNCTION NAME : admin_view_tech__details
 *
 * 	*DESCRIPTION : This function is used to view all records in the tecnician database by the admin
 * 	
 * 	*RETURNS : No returns
 *
 *********************************************************************************************************************************/			
 ...
 *
 * 	*DESCRIPTION : This function is used to request for a service,if found transaction is done by the admin
 * 	
 * 	*RETURNS : No returns
 *
 *********************************************************************************************************************************/			
